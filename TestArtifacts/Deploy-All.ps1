...
Write-Host ''
Write-Host '====================================================='
Write-Host '  AXIOS SCANNER — DEPLOYING ALL TEST ARTIFACTS'
Write-Host '====================================================='
Write-Host ''
...
Write-Host '  .\Invoke-AxiosCompromiseScanner.ps1 `'
Write-Host '    -Path C:\AxiosScannerTest `'
Write-Host '    -TestCacheDir      C:\AxiosScannerTest\Check4\FakeCache `'
Write-Host '    -TestFirewallLogPath C:\AxiosScannerTest\Check8\test-pfirewall.log'
Write-Host ''
...
Write-Host '  Check 5  Dropped Malware Payloads  FAIL  axios-test-dropper.exe in Temp'
Write-Host '  Check 6  Persistence Mechanisms    FAIL  AxiosScannerTest Run key'
