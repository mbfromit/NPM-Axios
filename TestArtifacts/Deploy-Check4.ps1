...
.USAGE
  .\Deploy-Check4.ps1
  .\Invoke-AxiosCompromiseScanner.ps1 -Path C:\AxiosScannerTest -TestCacheDir C:\AxiosScannerTest\Check4\FakeCache
  (The -TestCacheDir flag bypasses 'npm config get cache' and points directly at the fake cache.)
#>

$cacheDir = 'C:\AxiosScannerTest\Check4\FakeCache'
...
Write-Host "          .\Invoke-AxiosCompromiseScanner.ps1 -Path C:\AxiosScannerTest -TestCacheDir '$cacheDir'"
